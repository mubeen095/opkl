      ...
      <div className="feedback-card-container">
        <div className="feedback-card">
          <p className="feedback-message">
            The coding company Technologies Private Limited excels in innovative software
            and IT services, delivering high-quality, client-focused
            products. Their expert team ensures customer satisfaction, making
            The coding company a reliable partner in the tech industry.
          </p>
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            The coding company, It's very easy to learn and topics&amp; all courses is
            available what people is trying to learn and budget friendly to
            learn the courses . Thank u The coding company
          </p>
          <div className="feedback-card-foot">
            <div className="personImg">
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            Choosing The coding company for my internship was a great decision, as I gained a
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            The coding company is a good option toy internship. I feel very good to join in
            this internship. I have learn more from this The coding company, thank you.
          </p>
          <div className="feedback-card-foot">
            <div className="personImg">
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            The coding company is a robust and user-friendly platform for managing tasks,
